            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <select class="form-select @error('id_penduduk') is-invalid @enderror" name="id_penduduk" required>
                        ...
                        @foreach($penduduk as $item)
                            <option value="{{ $item->id_penduduk }}" {{ old('id_penduduk', $penerima->id_penduduk) == $item->id_penduduk ? 'selected' : '' }}>
                                {{ $item->nama }} - {{ $item->nik }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('program_bantuan') is-invalid @enderror" name="program_bantuan" required>
                        ...
                        <option value="Bantuan Langsung Tunai (BLT)" {{ old('program_bantuan', $penerima->program_bantuan) == 'Bantuan Langsung Tunai (BLT)' ? 'selected' : '' }}>Bantuan Langsung Tunai (BLT)</option>
                        <option value="Bantuan Pangan Non Tunai (BPNT)" {{ old('program_bantuan', $penerima->program_bantuan) == 'Bantuan Pangan Non Tunai (BPNT)' ? 'selected' : '' }}>Bantuan Pangan Non Tunai (BPNT)</option>
                        <option value="Program Keluarga Harapan (PKH)" {{ old('program_bantuan', $penerima->program_bantuan) == 'Program Keluarga Harapan (PKH)' ? 'selected' : '' }}>Program Keluarga Harapan (PKH)</option>
                        <option value="Bantuan Sosial Tunai (BST)" {{ old('program_bantuan', $penerima->program_bantuan) == 'Bantuan Sosial Tunai (BST)' ? 'selected' : '' }}>Bantuan Sosial Tunai (BST)</option>
                        <option value="Bantuan Pendidikan" {{ old('program_bantuan', $penerima->program_bantuan) == 'Bantuan Pendidikan' ? 'selected' : '' }}>Bantuan Pendidikan</option>
                        <option value="Bantuan Kesehatan" {{ old('program_bantuan', $penerima->program_bantuan) == 'Bantuan Kesehatan' ? 'selected' : '' }}>Bantuan Kesehatan</option>
                        <option value="Lainnya" {{ old('program_bantuan', $penerima->program_bantuan) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                    </select>
